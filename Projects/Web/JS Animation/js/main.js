        ...
        function render() {
            ...
            for (var ix = 0; ix < AMOUNTX; ix++) {
                for (var iy = 0; iy < AMOUNTY; iy++) {
                    ...
                    particle.position.y = (Math.sin((ix + count) * 0.15) * 50) + (Math.sin((iy + count) * 0.5) * 50);
                    particle.scale.x = particle.scale.y = (Math.sin((ix + count) * 0.15) + 1) * 4 + (Math.sin((iy + count) * 0.5) + 1) * 4;
                }
            }
